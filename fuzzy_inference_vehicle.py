...
class FuzzyInference:
    ...
    def initFuzzySystem(self):
        ...
        delayRemain.add_trapezoidal('S', 0, 0, 0.1, 0.2)
        delayRemain.add_triangular('M', 0, 0.2, 0.3)
        delayRemain.add_trapezoidal('H', 0.5, 0.6, self.MAX_DELAY_REMAIN, self.MAX_DELAY_REMAIN)
    ...
    def vehicleInference(self, delayRemain, packageSize, showResult=False, plot=False):
        ...
        outputVector = [output['Car Probability'], output['RSU Probability'], output['GNB Probability'],
...
### TEST
FuzzySystemTest = FuzzyInference(1, 10)
FuzzySystemTest.vehicleInference(1, 10, True, True)
